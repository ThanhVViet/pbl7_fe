...
const Loader = () => {
            ...
            <div className="loader">
                <svg height={0} width={0} viewBox="0 0 64 64" className="absolute">
                    <defs className="s-xJBuHA073rTt" xmlns="http://www.w3.org/2000/svg">
                        <linearGradient className="s-xJBuHA073rTt" gradientUnits="userSpaceOnUse" y2={2} x2={0} y1={62}
                                        x1={0} id="b">
                            <stop className="s-xJBuHA073rTt" stopColor="#973BED"/>
                            <stop className="s-xJBuHA073rTt" stopColor="#007CFF" offset={1}/>
                        </linearGradient>
                        <linearGradient className="s-xJBuHA073rTt" gradientUnits="userSpaceOnUse" y2={0} x2={0} y1={64}
                                        x1={0} id="c">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" height={64} width={64}
                    ...
                    <path strokeLinejoin="round" strokeLinecap="round" strokeWidth={8} stroke="url(#b)"
                          ...
                          className="dash" id="y" pathLength={360}/>
                </svg>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    style={{animationDuration: '0ms', animationDirection: 'normal'}}
                    viewBox="0 0 64 64"
                    height={64}
                    width={64}
                    className="inline-block"
    ...
    a 27 27 0 1 1 0 -54"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                     ...
                     width={64} className="inline-block">
                    <path strokeLinejoin="round" strokeLinecap="round" strokeWidth={8} stroke="url(#d)"
                          ...
                          className="dash" id="u" pathLength={360}/>
                </svg>
            </div>
        </StyledWrapper>
    );
